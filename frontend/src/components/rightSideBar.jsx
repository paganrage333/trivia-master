  ...
  return (
    <>
     <aside className="hidden xl:col-span-4 xl:block max-h-screen">
                    ...
                    <li className="flex items-center space-x-3 py-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          <a href="#">{Cats.find((el)=>{return el.id == e.category})?.name}</a>
                        </p>
                      </div>
                      <div className="flex-shrink-0">
                        <button
                         onClick={()=>{setOpenCreateTrivia(true);setSelectedQue(i)}}
                          type="button"
      ...
      {
    openCreateTrivia &&
        <CreateTrivia  Cats={Cats} que={que[selectedQue]} setOpenCreateTrivia={setOpenCreateTrivia} setAddTrivia={setAddTrivia} />
      }
    </>
  )
}
